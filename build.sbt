...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark" %% "spark-streaming-kafka-0-10" % "3.4.0", // Adjust Spark version as needed
  "org.apache.kafka" % "kafka-clients" % "3.4.0" ,// Adjust Kafka version as needed
  "com.squareup.okhttp3" % "okhttp" % "4.9.2",
  //"org.apache.kafka" %% "kafka" % "3.0.0", // Kafka client for Scala
